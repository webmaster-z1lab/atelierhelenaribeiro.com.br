<template>
  <div class="content">
    ...
    <div class="container-fluid mt--6">
      <card>
        <div slot="header">
          <h3 class="mb-0">Adicionar Funcionário</h3>
        ...
        <form class="needs-validation" @submit.prevent="submitForm">
          ...
          <div class="form-row">
            <div class="col-lg-3">
              <base-input name="name" label="Nome" placeholder="João das Neves" v-model="name" :error="getError('name')" :valid="isValid('name')" v-validate="'required'"/>
            </div>
            <div class="col-lg-3">
              <base-input type="email" name="email" label="Email" placeholder="joao@email.com" v-model="email" :error="getError('email')" :valid="isValid('email')" v-validate="'email'"/>
            </div>
            <div class="col-lg-3">
              <mask-input placeholder="000.000.000-00" name="document" label="CPF" v-model="document" :mask="'###.###.###-##'" validate="required|cpf"/>
            </div>
            <div class="col-lg-3">
              <base-input name="identity" label="Identidade" placeholder="MG 00.000.000" v-model="identity" :error="getError('identity')" :valid="isValid('identity')" v-validate="'required'"/>
            </div>
            <div class="col-lg-3">
              <base-input name="work_card" label="Carteira de Trabalho (CTPS/Série)" placeholder="0000000/00000" v-model="work_card" :error="getError('work_card')" :valid="isValid('work_card')" v-validate="'required'"/>
            </div>
            <div class="col-lg-3">
              <mask-input name="birth_date" placeholder="DD/MM/AAAA" label="Data de Nascimento" v-model="birth_date" :mask="'##/##/####'" :masked="true"
                          validate="required|date_format:dd/MM/yyyy|before_today"/>
            </div>
            <div class="col-lg-3">
              <mask-input name="admission_date" placeholder="DD/MM/AAAA" label="Data de Admissão" v-model="admission_date" :mask="'##/##/####'" :masked="true"
                          validate="required|date_format:dd/MM/yyyy|before_today"/>
            </div>
            <div class="col-lg-3">
            ...
            <div class="col-lg-4">
              <phone-input placeholder="(00) 00000-0000" :phone="phone" name="phone" :validate="true"/>
            </div>
            <div class="col-lg-4">
