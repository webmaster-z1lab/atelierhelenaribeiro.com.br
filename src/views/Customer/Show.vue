                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col mb-4" v-for="(phone, key) in customer.phones">
                          <h4>Telefone {{++key}}:</h4>
                          <h5 class="mb-0">
                    ...
                    <div class="col-12">
                      ...
                      <ul class="list-group list-group-flush" data-toggle="checklist">
                        <li class="checklist-entry list-group-item flex-column align-items-start py-4 px-4" v-for="owners in customer.owners">
                          <div class="checklist-item">
                            <div class="checklist-info">
                              <h5 class="checklist-title mb-0">{{owners.name}}</h5>
                              <small><strong>Email: </strong> {{owners.email}}</small>
                              <small class="mx-3">
                                <strong>Contato: </strong>
                                <i :class="owners.phone.is_whatsapp ? 'fab fa-whatsapp mr-1' : 'fas fa-phone mr-1'"></i> {{owners.phone.formatted}}</small>
                              <small class="mx-3"><strong>Documento: </strong> {{owners.document}}</small>
                            </div>
                          </div>
                        </li>
                      </ul>
